...
score1 = int(input('1과목 점수를 입력하라'))
score2 = int(input('2과목 점수를 입력하라'))
score3 = int(input('3과목 점수를 입력하라'))
...
print(f'합격여부:{exampleCalculator.getTotalScore(score1, score2, score3)}')